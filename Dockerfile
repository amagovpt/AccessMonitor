...
WORKDIR /usr/local/apache2/htdocs/amp
COPY --from=builder /app/build /usr/local/apache2/htdocs/amp
COPY --from=builder /app/.htaccess /usr/local/apache2/htdocs/amp
